...
class SqlitedbService extends BasedbService {
  ...
  init() {
    ...
    let userTableExists = masterStmt.get("table", this.userTableName);
...
let sqlitedbServiceInstance = null;

module.exports = {
  SqlitedbService,
  get sqlitedbService() {
    if (!sqlitedbServiceInstance) {
      sqlitedbServiceInstance = new SqlitedbService();
    }
    return sqlitedbServiceInstance;
  },
};
