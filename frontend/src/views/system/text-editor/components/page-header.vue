    ...
    <el-row justify="space-between" align="middle">
      <el-col :span="12">
        <div class="header-left">
          <h3 v-if="!showDiffView">{{ $t("textEditor.title") }}</h3>
          <h3 v-if="showDiffView">{{ $t("textEditor.diffTitle") }}</h3>
          <FormatSelector
      ...
      <el-col :span="12" class="btn-header-right">
        ...
        <el-tooltip
          :content="isSaved ? $t('textEditor.saved') : $t('textEditor.unsaved')"
          placement="top"
          effect="light"
          :disabled="!showTooltips"
        >
        ...
        <el-tooltip
          :content="$t('textEditor.showConfig')"
          placement="top"
          effect="light"
          :disabled="!showTooltips"
        >
        ...
        <el-tooltip
          :content="
            isPinned ? $t('textEditor.unpinBtn') : $t('textEditor.pinBtn')
          "
          placement="top"
          effect="light"
          :disabled="!showTooltips"
